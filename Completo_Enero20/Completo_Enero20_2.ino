...
void setup()
   {
      ...
      lcd.print("Estoy iniciando.");
      
      delay(2500);//Delay para inicializar sistema
   }
void loop()
   {  
     //Inicio sistema
     ...
     if (isnan(h) || isnan(t)) {
      ...
      int val_humedad_porcentaje = map(val_humedad,0,911,0,100); //convierto a porcentaje
      ...
      if  (distancia < 14) // 9 cm = 1000 mm Agua
      {
        ...
        // 24Ene20 = 890
        // 23Ene20 = 886 
        // 21Ene20 = minimo 887 (Necesitaba agua); maximo 892 (Luego de leve riego) > En planta
        // Sumergido = 893; Seco = 8
     ...
     for (i=0 ; i<=3000; i++) //3600 segundos = 60 minutos
      {
        Serial.println(i, " segundos");
        delay(i+"000");
        lcd.setCursor ( 11 , 1 ); // go to the 2nd line
        lcd.print(i);
        }
    ...
    int readSoil()
      {
        ...
        delay(50);//wait 10 milliseconds - Espera 10 segundos
